...
export default () => (
  <div className="methodology">
    ...
    <ul>
      <li>les expérimentations portées principalement par un désir d'exploration technologique</li>
    ...
    <p />
    <p>Critères d'admission dans le studiolo pour une pièce :</p>
    <p />
    <ul>
      <li>implication d'un chercheur (au sens d'un professionnel financé par une institution de recherche) - limite stricte</li>
      <li>objet d'étude relevant de l'expérience humaine, et pas exclusivement d'objets "naturels" tels que ceux de la physique, de la biologie ou des mathématiques - limite souple</li>
      <li>mode d'expérimentation de la forme de la pièce fortement induit par la méthodologie ou l'argument soutenu par la démarche de recherche - limite souple</li>
      <li>présence d'un mode d'interprétation et d'élaboration critique explicite à propos de l'objet d'étude - limite souple</li>
      <li>les textes de la pièce sont accessibles en français ou en anglais - limite stricte</li>
    </ul>
    <p />
    <p>Critères de non-admission :</p>
    <ul>
